...
export type NetworkConfig = {
    ...
    spaceFactory: string;
    authenticators: {
        [key: string]: VanillaAuthenticatorConfig | EthTxAuthenticatorConfig | EthSigAuthenticatorConfig | undefined;
    };
    strategies: {
        [key: string]: VanillaStrategyConfig | CompStrategyConfig | OzVotesStrategyConfig | WhitelistStrategyConfig | SingleSlotProofStrategyConfig | undefined;
    };
    executors: {
        [key: string]: StarknetExecutionConfig | VanillaExecutionConfig | EthRelayerExecutionConfig | AvatarExecutionConfig | undefined;
    };
};
