...
export interface Strategy {
    ...
    getVotingPower: (strategyAddress: string, voterAddress: string, timestamp: number, params: string[], clientConfig: ClientConfig) => Promise<bigint>;
}
...
export type Message = VanillaProposeMessage | VanillaVoteMessage | EthSigProposeMessage | EthSigVoteMessage;
